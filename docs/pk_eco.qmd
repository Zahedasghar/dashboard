...
subtitle: "Real-time Economic Analysis & Policy Insights - Under Development"
...
### Policy Rate and Inflation Dynamics {width=50%}
...
## Key Economic Insights {width=70%}

### **Pakistan's Economic Performance Analysis (FY2025)**

**🔍 Current Economic Situation:**
Pakistan's economy in FY2025 shows a **mixed recovery pattern** with significant policy adjustments yielding positive results in key areas:

**📈 Growth & Sectoral Performance:**
- **GDP Growth**: At 2.68%, Pakistan maintains moderate growth despite global headwinds
- **Sectoral Divergence**: Agriculture shows resilience (0.56% growth) while Industry leads recovery (4.77%)
- **Services Sector**: Steady contribution with 2.99% growth, indicating domestic demand stability

**💰 Monetary Policy Success:**
- **Inflation Control**: Dramatic improvement from 29.2% (2023) to 4.5% (2024) - a major policy victory
...
- **Debt Management**: Debt-to-GDP ratio declining to 85.2%, showing fiscal discipline
- **Revenue Enhancement**: Tax revenue growth at 12.7% indicates improving collection
...
- **Employment**: Unemployment at 5.8% requires targeted interventions
...
|---------------|-------------|--------------|------------|
| GDP Growth | 2.68% | Variable | 🟡 Moderate |
| Inflation | 4.5% | 29.2% | 🟢 Excellent |
